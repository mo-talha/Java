...
Student student = new Student(“Taz”, 46, 25); This is a parametrized constructor, it will create an object of student in heap memory with default values as passed in the arguments.
...
Student student1 = new Student(); This will create an object whose age property will be set to 10. 

Also if we write any other constructor, the default constructor will be invalid.
This is not the case for when we overload default constructors.
